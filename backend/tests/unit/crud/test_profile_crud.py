...
from crud.profile import (
    create_coach_profile, authenticate_coach, 
    get_coach_by_email, update_coach_profile
)
...
class TestProfileCRUD:
    ...
    def test_create_coach_duplicate_email(self, db_session: Session):
        create_coach_profile(db_session, CoachProfileCreate(
    ...
    def test_authenticate_coach_success(self, db_session: Session):
        profile = create_coach_profile(db_session, CoachProfileCreate(
            full_name="Для входа", 
            phone="+79990005555",
            email="auth@test.com", 
