...
import type { TrainingFormData, AthletesData } from '../../../types/types';
						...
						<Grid item xs={6}>
							<FormControl fullWidth>
								...
								>
									...
									<MenuItem value='В процессе'>
										В процессе
									</MenuItem>
									<MenuItem value='Завершенная'>
										Завершенная
									</MenuItem>
								</Select>
							</FormControl>
				...
				<Box sx={{ mb: 3 }}>
					...
					<FormControl fullWidth sx={{ mt: 2 }}>
						...
						>
							...
							<MenuItem value='Профессиональный'>
								Профессиональный
							</MenuItem>
						</Select>
					</FormControl>
