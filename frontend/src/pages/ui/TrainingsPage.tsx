...
export const TrainingsPage = () => {
  ...
  const fetchPlans = async () => {
    try {
      setLoading(true);
      const res = await getAllTrainings(localStorage.getItem("access_token")!);
  ...
  const handleAddTraining = async (trainingData: TrainingFormData) => {
    try {
      setLoading(true);
      await createTraining(localStorage.getItem("access_token")!, trainingData);
    ...
    >
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        {[
          ...
          {
            label: "Запланировано",
            value: trainings.filter((t) => t.status === "Запланированная")
              .length,
          },
          {
            label: "Завершено",
            value: trainings.filter((t) => t.status === "Завершенная").length,
          },
        ].map((stat, idx) => (
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mb: 4 }}>
        ...
        <FormControl size="small" sx={{ minWidth: 150 }}>
          ...
          >
            ...
            <MenuItem value="Запланированная">Запланированные</MenuItem>
